...
\begin{enumerate}
    \item Realizar una revisión sistemática de literatura para identificar arquitecturas y herramientas que fundamenten el diseño técnico del sistema de lectura de medidores de agua.
    \item Desarrollar una aplicación móvil para la captura y procesamiento de imágenes, implementando algoritmos de visión por computadora resistentes a variaciones ambientales, para obtener datos de entrada optimizados para el reconocimiento.
    \item Implementar un modelo de Reconocimiento Óptico de Caracteres, utilizando técnicas de aprendizaje automático optimizadas para dispositivos móviles, para extraer con precisión las lecturas numéricas de los medidores.
    \item Validar la funcionalidad del prototipo completo, mediante pruebas comparativas en condiciones reales, para demostrar su viabilidad como solución al problema de lectura manual de medidores.
\end{enumerate}
...
\label{subsec:research_limitations}
