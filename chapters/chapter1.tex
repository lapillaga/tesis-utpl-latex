...
En el contexto de América Latina, y específicamente en Ecuador, las Juntas Administradoras de Agua Potable y Saneamiento (JAAPS) emergen como la estructura predominante y legalmente reconocida para la gestión del agua en el sector rural. Se estima que existen más de 5,000 de estas organizaciones en el país, brindando servicio a un porcentaje significativo de la población rural dispersa y desempeñando un rol crucial que el Estado no siempre logra cubrir \parencite{BID2022GestionComunitaria, RoaGarcia2019}. Su labor no solo garantiza el suministro de agua a millones de personas, sino que también fomenta la cohesión social y la gobernanza local de los recursos naturales. Este modelo representa una forma de gestión democrática descentralizada; por lo tanto, fortalecer su capacidad operativa no es solo una mejora técnica, sino una intervención directa para robustecer las instituciones comunitarias y la resiliencia local.

Sin embargo, la sostenibilidad de estas organizaciones enfrenta un desafío paradójico. Si bien son efectivas para expandir la cobertura, a menudo luchan con limitaciones técnicas, financieras y administrativas que comprometen su viabilidad a largo plazo \parencite{Toma2020}. La falta de herramientas tecnológicas adaptadas a su realidad operativa, caracterizada por recursos limitados y brechas de capacidad técnica, agrava estas dificultades y amenaza la calidad y continuidad del servicio. Este trabajo de titulación se enmarca en la búsqueda de soluciones tecnológicas pertinentes y apropiadas para fortalecer a estas organizaciones vitales, mejorando su autosuficiencia y capacidad de gestión.

\section{Problemática}
\label{sec:problem_statement}

Si bien las JAAPS son un pilar en la gestión del agua rural, su modelo operativo tradicional se ve amenazado por un conjunto de ineficiencias críticas que comprometen su sostenibilidad financiera y la confianza de la comunidad. El núcleo de esta problemática reside en el proceso de toma de lecturas, una tarea manual que es fundamental para el ciclo de facturación y la gestión del recurso. Este proceso, que implica el desplazamiento de un operario para transcribir los valores de cada medidor en papel, es inherentemente lento, laborioso y propenso a errores humanos que contribuyen directamente a las \textit{pérdidas comerciales} del sistema \parencite{Chaki2019Automation}. Estas pérdidas aparentes, causadas por errores en la lectura y en la manipulación de datos, generan una subvaloración del consumo real, conduciendo a una facturación imprecisa y a la pérdida de ingresos vitales para la junta \parencite{ANC2025}.

La magnitud del problema es alarmante. El Agua No Contabilizada (ANC), un indicador que engloba tanto las pérdidas técnicas (fugas) como las comerciales, alcanza un promedio nacional del 51.8\% en los sistemas gestionados por los Gobiernos Autónomos Descentralizados (GAD) Municipales, con cifras que pueden ser aún mayores en sistemas comunitarios más pequeños \parencite{INEC2023}. Estas imprecisiones se ven agravadas por los desafíos logísticos. El personal de las JAAPS debe cubrir áreas geográficamente dispersas, a menudo con topografía compleja, lo que resulta en demoras operativas. Además, la dependencia de una conectividad a internet intermitente o inexistente en muchas de estas zonas ha sido una barrera histórica para la adopción de soluciones digitales, que frecuentemente requieren una conexión constante \parencite{Fieldeke2021}. Esta ``brecha digital'' obliga a las JAAPS a perpetuar flujos de trabajo basados en papel, con la consecuente duplicación de esfuerzos para la digitación de datos, introduciendo una segunda fuente de posibles errores.

Las consecuencias de estas fallas operativas son sistémicas. Una facturación errónea erosiona la confianza de los usuarios, lo que puede derivar en una cultura de impago y afectar la recaudación. A su vez, la falta de datos de consumo fiables impide a la directiva realizar análisis técnicos esenciales, como el cálculo del balance hídrico o la detección temprana de fugas, componentes clave para la gestión sostenible del recurso \parencite{ANC2025}. En última instancia, este círculo vicioso de ineficiencia y debilidad técnica limita la capacidad de las JAAPS para planificar inversiones, realizar mantenimientos y garantizar la sostenibilidad a largo plazo del servicio.
...
\item Diseñar, entrenar y optimizar un \textit{pipeline} de visión artificial de dos etapas, compuesto por un detector de objetos para la localización del contador y un modelo de Reconocimiento Óptico de Caracteres (OCR) basado en redes neuronales convolucionales y recurrentes (CRNN), para la lectura de la secuencia de dígitos, asegurando una alta precisión y baja latencia en un entorno móvil \textit{offline}.
