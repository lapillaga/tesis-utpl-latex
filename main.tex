...
% Arial no disponible en LaTeX, usar fuente sans-serif más similar
\usepackage{cmbright} % Fuente sans-serif clara
...
% Configuración de fuente Arial 11pt (usando cmbright como equivalente)
...
% Configuración de captions para tablas y figuras (Arial 10pt)
\captionsetup{
    font={footnotesize,doublespacing},
    labelfont=bf,
    textfont=it,
